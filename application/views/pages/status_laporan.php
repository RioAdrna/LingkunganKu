    <style>
        ...
        @media (max-width: 576px) {
            ...
            #tabel_status td:nth-child(1),
            #tabel_status th:nth-child(1),
            #tabel_status td:nth-child(3),
            #tabel_status th:nth-child(3) {
                    ...
                    <div class="card">
                        <div class="card-header border-2">
                            <div class="row align-items-center">
                                <div class="col-12 col-sm-8">
                                    <h6 class="mb-0">
                                        <i class="fas fa-clipboard-check"></i>&nbsp; Riwayat & Status Laporan
                                    </h6>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="tabel_status" class="table table-stripped" style="width:100%">
                                    <thead>
                                        <tr>
